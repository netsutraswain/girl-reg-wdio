...
import type { BidiHandler } from 'webdriver/src/bidi/handler.js';
import type { EventData } from 'webdriver/src/bidi/localTypes.js';
import type { CommandData } from 'webdriver/src/bidi/remoteTypes.js';
import type { CommandResponse } from 'webdriver/src/bidi/localTypes.js';
import type { RequestStartEvent, RequestEndEvent, RequestPerformanceEvent, RequestRetryEvent } from 'webdriver/src/request/types.js';
 ...
 */
export declare class CommandRuntimeOptions {
    mask?: boolean;
    constructor(options: {
        mask?: boolean;
    });
