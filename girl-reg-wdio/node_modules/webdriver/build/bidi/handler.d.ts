 ...
 * ./scripts/bidi/**
 */
import type * as local from 'webdriver/src/bidi/localTypes.js';
import type * as remote from 'webdriver/src/bidi/remoteTypes.js';
import { BidiCore } from 'webdriver/src/bidi/core.js';
export declare class BidiHandler extends BidiCore {
     ...
     **/
    sessionSubscribe(params: remote.SessionSubscribeParameters): Promise<local.SessionSubscribeResult>;
    /**
     ...
     **/
    browsingContextStartScreencast(params: remote.BrowsingContextStartScreencastParameters): Promise<local.BrowsingContextStartScreencastResult>;
    /**
     ...
     **/
    browsingContextStopScreencast(params: remote.BrowsingContextStopScreencastParameters): Promise<local.BrowsingContextStopScreencastResult>;
    /**
