import { Preprocessor } from 'parse5/dist/tokenizer/preprocessor.js';
import { type Token, type CharacterToken, type DoctypeToken, type TagToken, type EOFToken, type CommentToken, type Attribute, type Location } from 'parse5/dist/common/token.js';
import { EntityDecoder } from 'parse5/node_modules/entities/decode.js';
import { ERR, type ParserErrorHandler } from 'parse5/dist/common/error-codes.js';
